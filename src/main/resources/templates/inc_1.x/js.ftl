...
<link rel="stylesheet" type="text/css" href="${cdn}/lib/easyui-1.4.3/themes/IconExtension.css">
<link rel="stylesheet" type="text/css" href="${cdn}/lib/easyui-1.4.3/themes/icon_nat.css">
...
<script type="text/javascript" src="${cdn}/lib/jqueryvalidate/messages_zh.min.js"></script>
<script src="${cdn}/lib/select2/js/select2.min.js"></script>
<script type="text/javascript" src="${cdn}/lib/jquery/jquery.cookie.js"></script>
...
<script type="text/javascript" src="${cdn}/lib/echarts/echarts-3.7/echarts.js"></script>
