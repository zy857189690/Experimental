                ...
                <div align="center">
                    <table width="90%" class="mt10">
                        ...
                        <tr>
                            ...
                            <td> <input required name="vin" style="width:180px;"  type="text" class="easyui-textbox input"/><a href="#" onclick="findvin()">&nbsp;&nbsp;查找</a></td>
                        </tr>
                        <tr>
                    ...
                    <table width="90%" class="mt10">
                        ...
                        <tr>
                            ...
                            <td> <input required name="serialNumber" style="width:180px;"  type="text" class="easyui-textbox input"/></td>
                        </tr>
                        <tr>
                            <td class="tab_item"><i><span>IMEI号</span></td>
                            <td> <input required name="imei" style="width:180px;"  type="text" class="easyui-textbox input"/></td>
                        </tr>
                    </table>
                    <table width="90%" class="mt10">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2"> <input required name="simCartNumber" style="width:180px;"  type="text" class="easyui-textbox input"/></td>
                        </tr>
                        <tr>
                            <td class="tab_item"><i><span>ICCID</span></td>
                            <td> <input required name="iccid" style="width:180px;"  type="text" class="easyui-textbox input"/></td>
                        </tr>
                        <tr>
                            <td class="tab_item"><span>国际移动台识别码（IMSI）</span></td>
                            <td> <input name="imsi" style="width:180px;"  type="text" class="easyui-textbox input"/></td>
                        </tr>
                    </table>
                    <table width="90%" class="mt10">
                        <tr>
