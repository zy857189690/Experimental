...
<div region="center" style="overflow: hidden;width: 100%;">
    <div id="toolbar" style="padding:5px" class="cg-moreBox">
        <a href="#" onclick="view_item()" class="easyui-linkbutton"
           data-options="iconCls:'icon-view'" menu="0">查看配方</a>
        <a href="#" onclick="add_item()" class="easyui-linkbutton"
           data-options="iconCls:'icon-add'" menu="0">添加新配方</a>
        <a href="#" onclick="edit_item()" class="easyui-linkbutton"
           data-options="iconCls:'icon-edit'" >修改配方</a>
    </div>
    <div id="table" name="datagrid" style="width: 100%;height: 100%"></div>
</div>

<div data-options="region:'north',title:'配方管理',split:true,collapsable:true" style="width: 100%;height: 190px">
...
<script>
    $('#table').datagrid({
        ...
        columns: [[
            ...
            {field: 'code', title: '配方编号'},
            {field: 'fname', title: '配方名称'},
            {field: 'fpeople', title: '配方创建人'},
            {field: 'pid', title: '所属项目编号'},
            {field: 'ftime', title: '配方创建时间'},
        ]],
        toolbar: "#toolbar",
        pagination: true,
        nowrap: true
