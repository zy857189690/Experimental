    ...
    <form id="ff" method="post" enctype="" novalidate>
        ...
        <table>
            ...
            <tr>
                <td class="td_input">
                    <input type='text' name='hno01' autocomplete="off" id='hno01' value="pbs"
                           style="height: 26px;width: 80px;background-color: #0d8ddb" readonly/>
                </td>
                <td class="td_input">
            ...
            <tr>
                ...
                <td class="td_input">
                    <input type='text' name='hno'14 autocomplete="off" id='hno14' value="200"
                           style="height: 26px;width: 80px" readonly/>
                </td>
                <td class="td_input">
                ...
                <td class="td_input">
                    <input type='text' name='hno19' autocomplete="off" id='hno19' value="5" style="height: 26px;width: 80px"
                           readonly/>
                </td>
                <td class="td_input">
                    <input type='text' name='hno20' autocomplete="off" id='hno20' value="2" style="height: 26px;width: 80px"
                           readonly/>
                </td>
                <td class="td_input">
                    <input type='text' name='hno21' autocomplete="off" id='hno21' value="1" style="height: 26px;width: 80px"
                           readonly/>
                </td>
                <td class="td_input">
                    <input type='text' name='hno22' autocomplete="off" id='hno22' value="0" style="height: 26px;width: 80px"
                           readonly/>
                </td>
                <td class="td_input">
                    <input type='text' name='hno23' autocomplete="off" id='hno23' value="${(demo1.hno23)!}"
                           style="height: 26px;width: 80px" readonly/>
                </td>
                <td class="td_input">
            ...
            <tr>
                ...
                <td class="td_input">
                    <input type='text' name='hno60' autocomplete="off" id='hno60' value="pbs"
                           style="height: 26px;width: 80px;background-color: #0d8ddb" readonly/>
                </td>
            </tr>
            <tr>
