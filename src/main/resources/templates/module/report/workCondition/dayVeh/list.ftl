...
<div id="report" class="easyui-window" title="列表说明" style="width:853px;height:530px; display: none;" data-options="iconCls:'',modal:true,resizable:false,closed:true">
...
<script>
    ...
    $('#table').datagrid({
        ...
        columns:[[
            ...
            {field:'lastEndMileage',title:'总里程',align:'center',halign:'center'},
