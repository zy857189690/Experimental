...
<script>
   ...
   $('#table').datagrid({
       ...
       frozenColumns:[[
           ...
           {field: 'reportDate', title: '时间',align:'center',halign:'center',sortable: false},
           {field: 'licensePlate', title: '车牌号',align:'center',halign:'center',sortable: false},
           {field: 'vin', title: 'VIN',align:'center',halign:'center',ortable: false},
       ]],
        columns: [[
            {field: 'vehTypeName', title: '车辆种类',align:'center',halign:'center',sortable: false},
            {field: 'vehModelName', title: '车辆型号名称',align:'center',halign:'center',sortable: false},
            {field: 'modelNoticeId', title: '车辆公告型号',align:'center',halign:'center',sortable: false},
            {field: 'manuUnitName', title: '车辆厂商',align:'center',halign:'center',sortable: false},
            {field: 'registerstatus', title: '车辆阶段',align:'center',halign:'center',sortable: false},
            {field: 'vehStateName', title: '车辆状态',align:'center',halign:'center',sortable: false},
            {field: 'useUnitName', title: '运营单位',align:'center',halign:'center',sortable: false},
            {field: 'areaName', title: '上牌区域',align:'center',halign:'center',sortable: false},
            {field: 'firstReg', title: '激活时间',align:'center',halign:'center',sortable: false},
            {field: 'saleTime', title: '销售日期',align:'center',halign:'center',sortable: false},
            {field: 'lastCommunicationTime', title: '最后通讯时间',align:'center',halign:'center',sortable: false},
            {field: 'lastCanValidTime', title: '有效CAN数据最后上传时间',align:'center',halign:'center',sortable: false},
            {field: 'lastChargeTime', title: '最后一次充电时间',align:'center',halign:'center',sortable: false},
            {field: 'chargeDischargeStateName', title: '充放电状态',align:'center',halign:'center',sortable: false},
            {field: 'gaugesMileage', title: '仪表里程(km)',align:'center',halign:'center',sortable: false},
            {field: 'totalVoltage', title: '总电压(V)',align:'center',halign:'center',sortable: false},
            {field: 'totalCurrent', title: '总电流(A)',align:'center',halign:'center',sortable: false},
            {field: 'speed', title: '车速(km/h)',align:'center',halign:'center',sortable: false},
            {field: 'soc', title: 'SOC(%)',align:'center',halign:'center',sortable: false},
            {field: 'location', title: '地理位置',align:'center',halign:'center',sortable: false},
            ...
            {field: 'iccid', title: 'ICCID',align:'left',halign:'center',sortable: false},
        ]],
        toolbar: "#toolbar",
        pagination: true,
        rownumbers: true,
