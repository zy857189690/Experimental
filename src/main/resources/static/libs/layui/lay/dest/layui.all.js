...
layui.define("jquery", function (i) {
    "use strict";
    var t = layui.jquery, a = (layui.hint(), layui.device()), e = "element", n = "layui-this", l = "layui-show", s = function () {
        this.config = {}
    };
    s.prototype.set = function (i) {
        ...
        var e = t(".layui-tab[lay-filter=" + i + "]"), n = e.children(".layui-tab-title"), l = e.children(".layui-tab-content");
    ...
    var o = {
        tabClick: function (i, a, s) {
            var o = s || t(this), a = a || o.index(), u = o.parents(".layui-tab"), c = u.children(".layui-tab-content").children(".layui-tab-item"), r = u.attr("lay-filter");
            ...
            var e = a || t(this).parent(), l = e.index(), s = e.parents(".layui-tab"), u = s.children(".layui-tab-content").children(".layui-tab-item");
            ...
            t(".layui-tab").each(function () {
                var s = t(this), u = s.children(".layui-tab-title"), c = (s.children(".layui-tab-content").children(".layui-tab-item"), 'lay-stope="tabmore"'), r = t('<span class="layui-unselect layui-tab-bar" ' + c + "><i " + c + ' class="layui-icon">&#xe61a;</i></span>');
    ...
    s.prototype.init = function (i) {
        var e = {
            tab: function () {
                ...
                var i, e, n, l = ".layui-nav", s = "layui-nav-item", o = "layui-nav-bar", u = "layui-nav-tree", c = "layui-nav-child", r = "layui-nav-more", d = 200, y = function (l, s) {
        ...
        if (u[0]) {
            ...
            return s ? (f.on("scroll", function () {
                ...
                r && clearTimeout(r), t || (r = setTimeout(function () {
                    var t = h ? o.height() : e(window).height(), n = h ? o.prop("scrollHeight") : document.documentElement.scrollHeight;
                    n - i - t <= m && (l || g())
                }, 100))
            }), a) : a
        }
